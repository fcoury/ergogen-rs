(module PG1350 (layer F.Cu) (tedit 5DD50112)
      ...
      (pad "" np_thru_hole circle (at -5.5 0) (size 1.7018 1.7018) (drill 1.7018) (layers *.Cu *.Mask))
          ...
          (pad 1 smd rect (at 3.275 -5.95 0) (size 2.6 2.6) (layers F.Cu F.Paste F.Mask)  (net {{net_from_id}} "{{net_from}}"))
          (pad 2 smd rect (at -8.275 -3.75 0) (size 2.6 2.6) (layers F.Cu F.Paste F.Mask)  (net {{net_to_id}} "{{net_to}}"))
        )