(module rotary_encoder (layer F.Cu) (tedit 603326DE)
            ...
            (pad A thru_hole rect (at -7.62 -2.54 0) (size 2 2) (drill 1) (layers *.Cu *.Mask) (net {{net_A_id}} "{{net_A}}"))
            (pad C thru_hole circle (at -7.62 -0.04) (size 2 2) (drill 1) (layers *.Cu *.Mask) (net {{net_C_id}} "{{net_C}}"))
            (pad B thru_hole circle (at -7.62 2.46) (size 2 2) (drill 1) (layers *.Cu *.Mask) (net {{net_B_id}} "{{net_B}}"))
            (pad 1 thru_hole circle (at 6.88 -2.54) (size 1.5 1.5) (drill 1) (layers *.Cu *.Mask) (net {{net_from_id}} "{{net_from}}"))
            (pad 2 thru_hole circle (at 6.88 2.46) (size 1.5 1.5) (drill 1) (layers *.Cu *.Mask) (net {{net_to_id}} "{{net_to}}"))
