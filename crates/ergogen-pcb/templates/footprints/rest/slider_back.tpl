(module E73:SPDT_C128955 (layer F.Cu) (tstamp 5BF2CC3C)
            ...
            (pad 1 smd rect (at -2.25 2.075 0) (size 0.9 1.25) (layers B.Cu B.Paste B.Mask) (net {{net_from_id}} "{{net_from}}"))
            (pad 2 smd rect (at 0.75 2.075 0) (size 0.9 1.25) (layers B.Cu B.Paste B.Mask) (net {{net_to_id}} "{{net_to}}"))
