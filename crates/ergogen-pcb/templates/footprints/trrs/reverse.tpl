(module TRRS-PJ-320A-dual (layer F.Cu) (tedit 5970F8E5)
      ...
      (fp_line (start 0.75 0) (end -5.35 0) (layer Dwgs.User) (width 0.15))
        ...
        (pad 1 thru_hole oval (at -2.3 11.3 0) (size 1.6 2.2) (drill oval 0.9 1.5) (layers *.Cu *.Mask) (net {{net_A_id}} "{{net_A}}"))
        (pad 2 thru_hole oval (at 2.3 10.2 0) (size 1.6 2.2) (drill oval 0.9 1.5) (layers *.Cu *.Mask) (net {{net_B_id}} "{{net_B}}"))
        (pad 3 thru_hole oval (at 2.3 6.2 0) (size 1.6 2.2) (drill oval 0.9 1.5) (layers *.Cu *.Mask) (net {{net_C_id}} "{{net_C}}"))
        (pad 4 thru_hole oval (at 2.3 3.2 0) (size 1.6 2.2) (drill oval 0.9 1.5) (layers *.Cu *.Mask) (net {{net_D_id}} "{{net_D}}"))
